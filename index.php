...
<head>
    ...
    <title>CETIEV  - Suivi de dossier</title>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="login.php">
                        <i class="bi bi-envelope"></i> Se connecter
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="container tracking-container">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center mb-4">
               ...
               <h1 class="display-5 fw-bold mb-3">Suivi et traçabilité du rapport</h1>
                <p class="lead">Entrez votre numéro de dossier pour accéder à votre espace sécurisé</p>
            </div>
            <div class="col-md-8">
                <form method="POST" action="recherche-dossier.php" id="trackingForm">
                    ...
                    <p class="text-muted text-center mt-3 small">
                        ...
                        Entrez votre numéro de dossier pour accéder à votre espace personnel
                                                  ...
                                                  <div class="g-recaptcha" data-sitekey="6Lf5qbosAAAAAAQw1-KCO_DpKCoriFaI1NgIjOqP"></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <p><i class="bi bi-telephone"></i> Service client: (+212)661 591 469 -(+212)522 583 958 </p>
